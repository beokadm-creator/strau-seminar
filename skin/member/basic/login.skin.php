...
<!-- 로그인 시작 { -->
<div id="mb_login" class="mbskin subpage pbt100">
    <div class="mbskin_box">
        ...
        <fieldset id="login_fs">
            <legend>회원로그인</legend>
            <label for="login_id" class="title">E-mail</label>
            <input type="text" name="mb_id" id="login_id" required class="frm_input required" size="20" maxLength="255" placeholder="이메일">
            <label for="login_pw" class="title">Password</label>
						<div class="pw_wrap">
							<input type="password" name="mb_password" id="login_pw" required class="frm_input required" size="20" maxLength="20" placeholder="비밀번호">
							<span class="pw_hidden"><img src="../<?php echo G5_SKIN_DIR ?>/member/basic/img/pwHidden_icon.png" alt="logo"></span>
						</div>
    ...
    <?php // 쇼핑몰 사용시 여기까지 반드시 복사해 넣으세요 ?>
		<div class="logo_wrap">
			<p>ONE ACCOUNT-OUR BRANDS</p>
			<ul class="dfbox">
				<li><a href="javascript:void(0);"><img src="../<?php echo G5_SKIN_DIR ?>/member/basic/img/login_logo01.png" alt="logo"></a></li>
				<li><a href="javascript:void(0);"><img src="../<?php echo G5_SKIN_DIR ?>/member/basic/img/login_logo02.png" alt="logo"></a></li>
			</ul>
		</div>
</div>
...
jQuery(function($){
    ...
    /* [OSJ : 2024-03-08] 비밀번호보기 기능 */
    $(".pw_hidden").click(function(){
        let target = $(this).siblings("input[name=mb_password]");
        let typeNm = "password";
        let imgFileNm = "pwHidden_icon.png";

        if(target.length > 0){
            if(target.attr("type") == "password"){
                typeNm = "text";
                imgFileNm = "pwHidden_icon.png"; /* [OSJ : 2024-03-08] 아이콘 변경 필요함. */
            }

            target.attr("type", typeNm);
            $(this).children("img:eq(0)").attr("src", "../<?php echo G5_SKIN_DIR ?>/member/basic/img/" + imgFileNm);
        }
    });
});
