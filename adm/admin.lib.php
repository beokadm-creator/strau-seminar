...
if (!$member['mb_id']) {
    ...
    if (!isset($auth['200150'])) {
        sql_query(" insert into {$g5['auth_table']} set mb_id = '{$member['mb_id']}', au_menu = '200150', au_auth = 'r,w,d' ");
        $auth['200150'] = 'r,w,d';
    }
    if (!isset($auth['700100'])) {
        sql_query(" insert into {$g5['auth_table']} set mb_id = '{$member['mb_id']}', au_menu = '700100', au_auth = 'r,w,d' ");
        $auth['700100'] = 'r,w,d';
    }
}
