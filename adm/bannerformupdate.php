...
@mkdir(G5_DATA_PATH."/banner_bbs", G5_DIR_PERMISSION);
@chmod(G5_DATA_PATH."/banner_bbs", G5_DIR_PERMISSION);
...
if ($bn_bimg_del)  @unlink(G5_DATA_PATH."/banner_bbs/$bn_id");
...
{
    @unlink(G5_DATA_PATH."/banner_bbs/$bn_id");
...
if ($w == "" || $w == "u")
{
    if ($_FILES['bn_bimg']['name']) upload_file_bbs($_FILES['bn_bimg']['tmp_name'], $bn_id, G5_DATA_PATH."/banner_bbs");
