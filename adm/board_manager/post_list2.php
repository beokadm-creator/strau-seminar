...
//    include_once(G5_ADMIN_BBS_PATH.'/board_head.php');
    ...
    /* [OSJ : 2025-03-11] launchingShow 게시판 고정처리 */
    $sbn = "launchingShow";
    //--- 게시판 선택
    if ($sbn != ''){
    ...
    if ($tblExist > 0) {
        ...
        //--- 게시물 가져오기
        $sql = "
            SELECT    wr_id, mb_id, wr_subject, wr_name, wr_hit, wr_datetime, tbl_name
            FROM      {$vTable}
            WHERE     {$sql_search}
...
<form name="fsearch" id="fsearch" class="local_sch01 local_sch" method="get">
    ...
    <div>
        ...
        <input type="hidden" name="sbn" value="launchingShow" />
...
<form name="boardlist" id="boardlist" action="./delete_all_show.php" onsubmit="return boardDelete(this);" method="post">
    <input type="hidden" name="page" value="<?php echo $page ?>">
    <input type="hidden" name="qstr" value="<?php echo $qstr ?>">
    <input type="hidden" name="token" value="">

    <div class="btn_fixed_top">
        <a href="<?=G5_URL ?>/launchingShow/write" class="btn_02 btn">강의등록</a>
        ...
        <a href="./lecture_show_list_excel.php" class="btn_02 btn">엑셀저장</a>
    </div>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col">제목</th>
						<th scope="col" class="width45p">수강자</th>
            <th scope="col" class="width45p">댓글수</th>
            <th scope="col">글쓴이</th>
            <th scope="col" class="width45p">조회</th>
        ...
        <?php } else { ?>
            ...
            <?php
                for ($k=0; $list=sql_fetch_array($res); $k++) {
                    $sql = "select COUNT(*) AS apply_cnt from g5_content_mypage_show where content_no = '{$list["wr_id"]}' ";
            ...
            ?>
                <tr class="">
                    ...
                    <td class="td_num"><?php echo $list['wr_hit']; ?></td>
                    ...
                    <td class="td_mng td_mng_l">
						...
						<a href="./lecture_show_list_excel.php?wr_id=<?=$list['wr_id']?>" class="btn_02 btn">엑셀저장</a>
                    </td>
                </tr>
            <?php } ?>
