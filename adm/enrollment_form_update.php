...
$mb_board_comment_cate = is_array($_POST['mb_board_comment_cate']) ? implode('|', $_POST['mb_board_comment_cate']) : clean_xss_tags($_POST['mb_board_comment_cate'], 1, 1);
$mb_qa_board_cate = is_array($_POST['mb_qa_board_cate']) ? implode('|', $_POST['mb_qa_board_cate']) : clean_xss_tags($_POST['mb_qa_board_cate'], 1, 1);
$posts['mb_board_comment_cate'] = $mb_board_comment_cate;
$posts['mb_qa_board_cate'] = $mb_qa_board_cate;
...
$sql_common = "  mb_name = '{$posts['mb_name']}',
                 ...
                 mb_profile = '{$posts['mb_profile']}',
                 mb_level = '{$posts['mb_level']}',
                 mb_board_comment = '{$posts['mb_board_comment']}',
                 mb_board_comment_cate = '{$posts['mb_board_comment_cate']}',
                 mb_qa_board_cate = '{$posts['mb_qa_board_cate']}',
                 mb_1 = '{$posts['mb_1']}',
                 mb_2 = '{$posts['mb_2']}',
                 mb_3 = '{$posts['mb_3']}',
                 mb_4 = '{$posts['mb_4']}',
                 ...
                 mb_9 = '{$posts['mb_9']}',
                 mb_10 = '{$posts['mb_10']}',
                 mb_shipping_postcode = '{$posts['mb_shipping_postcode']}',
                 mb_shipping_address = '{$posts['mb_shipping_address']}',
                 mb_shipping_detail = '{$posts['mb_shipping_detail']}' ";
if ($w == '') {
    $mb = get_member($mb_id);
...
goto_url('./enrollment_form.php?' . $qstr . '&amp;w=u&amp;mb_id=' . $mb_id, false);
