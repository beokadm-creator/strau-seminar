    ...
    <div class="tbl_frm01 tbl_wrap">
        <table>
            ...
            <tbody>
				...
				<tr>
                    <th scope="row"><label for="nw_content">이미지</label></th>
                    <td><input type="file" name="filename1"><br>
					<?if($nw['fileName']){?>
					<img src="<?php echo $nw['fileFath'] ?><?php echo $nw['fileName'] ?>" height="200">
					<?}?>
					</td>
                </tr>
				
				<tr>
                    <th scope="row"><label for="nw_content">링크</label></th>
                    <td><input type="text" name="nw_link" size="100"  class="frm_input" value="<?php echo $nw['nw_link'] ?>">새창 <input value="y" type="checkbox" name="nw_target" <?php if($nw['nw_target']=="y"){echo "checked";}?>></td>
                </tr>
