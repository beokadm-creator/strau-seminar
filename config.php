...
*/
define('G5_DOMAIN', '');
define('G5_HTTPS_DOMAIN', 'https://stkr-edu.com');

/* SSL 적용 */
if(empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == "off"){
 $redirect = 'https://stkr-edu.com'. $_SERVER['REQUEST_URI'];
...
/* [OSJ : 2024-03-13] 공통으로 사용할 이메일 주소 추가 */
define('COMMON_SEND_EMAIL', 'master@stkr-edu.com');
