...
gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하만 등록됩니다.</span>
	...
	<div class="register_right">
		<div class="register_summary sticky_summary">
			<h2>가입 요약</h2>
			...
			<div class="recommend_section">
				<label for="reg_mb_recommend">추천인 아이디</label>
				<input type="text" name="mb_recommend" id="reg_mb_recommend" class="frm_input" placeholder="추천인 아이디 입력">
			</div>
			<?php }  ?>

			<div class="btn_confirm_right">
				<button type="submit" id="btn_submit" class="btn_submit" accesskey="s"><?php echo $w==''?'회원가입 완료':'정보수정 완료'; ?></button>
...
$(function() {
	...
	$('#reg_mb_email').on('input', function() {
		$('#summary_email').text($(this).val() || '-');
	});
});
</script>
	</div>
