...
<article class="subpage board pbt100" id="bo_v">
    ...
    <section id="bo_v_link">
        ...
        ?>
				...
				<div class="video_container"><iframe src="<?php echo $link ?>"  frameborder="0" allowfullscreen  allow="autoplay;"></iframe></div>
    </section>
    <!-- } 관련링크 끝 -->
    <?php } ?>
		...
		<!-- 본문 내용 시작 { -->
		<div id="bo_v_con">
			<?php echo strip_tags($view['wr_content']); ?>
			<?php if ($view['file'][1]) { ?>
			<div class="down_text"><a href="<?php echo $view['file'][1]['href'];  ?>" class="view_file_download" download>관련 자료 다운로드</a></div>
			<?php } ?>
			<?php if ($view['wr_1']) { ?>
			<div class="info_btn"><a href="<?php echo $view['wr_1']; ?>" target="_blank">해당 제품 정보</a></div>
			<?php } ?>
		</div>
		<!-- } 본문 내용 끝 -->
