...
<style>
	.swiper-banner2-pagination .swiper-pagination-bullet:only-child {
...
<div class="banner_sect"><div style="width:100%;"><?php echo display_banner_bbs('슬라이드'); ?></div></div>
<div class="main">
...
<!--	<div class="product_sect" style="display: none;">
	...
	<div class="campus_sect">
		<div class="inner_container pbt50">
			<div class="tit_wrap dfbox hot">
				<h3 class="fs_34 fw_700">캠퍼스 HOT 영상 <span class="icon"></span></h3>
				<p class="fs_20 fw_300">실시간으로 많은 관심을 받고 있는 임플란트, 바이오머테리얼, 디지털 등 다양한 토픽의 강의를 확인하실 수 있습니다.</p>
			</div>
